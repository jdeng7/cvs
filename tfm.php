...
$auth_users = array(
    ...
    'user1' => '$2y$10$8Ay8wIA.QKjs6QEXn3op.uDbGNRnysvyniyODA609p9nL7DS/yTZK', 
    'dr19' => '$2y$10$Xm5CKe2KQhnmh8Rkwfds2u0HLDLGdKwSN5BWeVVXzdnJQntZgoKF2'
);
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                        <!--
                            <img src="https://image.ibb.co/h7bb8V/h3k-logo.png" alt="Tiny File Manager">
                        -->
                        </div>
                        <div class="text-center">
                            <h1 class="card-title">Tiny Tiny Shujia</h1>
                        </div>
                        <div class="card fat">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="fm_usr" name="fm_usr" required autofocus>
